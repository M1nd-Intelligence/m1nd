...
<p align="center">
  ...
  e 56 ferramentas MCP. Feito em Rust para agentes de IA.<br/>
...
<p align="center">
  ...
  <a href="#as-56-ferramentas">Ferramentas</a> &middot;
...
m1nd-mcp/      Servidor MCP, 56 handlers de ferramentas, JSON-RPC sobre stdio, servidor HTTP + GUI
```
